...
public class CsvController {
    ...
    public List<Transaction> uploadCSVFile(@NotNull @RequestParam ("csvVersion") String csvVersion,
                                           @RequestParam ("accountId") String accountId,
                                           @RequestParam("file") MultipartFile file) throws IOException {
        log.trace("Received uploadCSVFile request csvVersion: {} accountId: {} fileName: {}",
                csvVersion, accountId, file.getOriginalFilename());
