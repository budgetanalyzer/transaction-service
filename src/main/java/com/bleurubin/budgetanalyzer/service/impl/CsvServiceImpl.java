...
public class CsvServiceImpl implements CsvService {
    ...
    public List<Transaction> importCSVFile(String csvVersion, String accountId, MultipartFile file) throws IOException {
        log.trace("Importing csv file csvVersion: {} for file: {}", csvVersion, file.getOriginalFilename());

        var csvData = csvParser.parseCSVFile(file);
        return createTransactions(csvVersion, accountId, csvData);
    }

    private List<Transaction> createTransactions(String csvVersion, String accountId, CsvData csvData) {
